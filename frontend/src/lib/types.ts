...
export interface ScholarshipRule { course?: string | null; minimum_marks?: number | null; income_limit?: number | null; state?: string | null; category?: string | null; important_condition: string; details_verified: boolean }
